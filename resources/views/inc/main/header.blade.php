                ...
                <ul id="menu-header" class="navbar-nav justify-content-end">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) === 'menaka-spa' ? 'active' : null }}"
                            href="{{ url('/menaka-spa') }}">Menaka Spa</a>
                    </li>
                    <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) === 'experience' ? 'active' : null }}"
                            href="{{ url('/experience') }}">Experience</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link {{ Request::segment(1) === 'gallery' ? 'active' : null }}"
...
<a href="https://api.whatsapp.com/send?phone={{ $settings->wa_number }}&text={{ $settings->wa_message }}"
    class="float shadow-none" target="_blank">
