                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Update Villa
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('villa.update', ['id' => $villa->id]) }}" method="POST"
                                                    ...
                                                    <div class="col-auto">
                                                        @if ($villa->image)
                                                            <img class="img-fluid rounded" id="modal-preview"
                                                                src="{{ asset('/img/villas/' . $villa->image) }}"><br><br>
                                                        @else
                                                            <img class="img-fluid rounded" id="modal-preview"
                                                        ...
                                                        <div class="form-group m-checkbox-inline mb-0">
                                                            ...
                                                            <div class="column-count-2">
                                                                @foreach ($serviceVilla as $value)
                                                                    <span>{{ Form::checkbox('services[]', $value->id, in_array($value->id, $serviceActive) ? true : false, ['class' => 'allService']) }}
                                                                        {{ $value->name }}</span>
                                                                    <br />
                                                                @endforeach
                                                            </div>
                                                        ...
                                                        <div class="form-group m-checkbox-inline mb-0">
                                                            ...
                                                            <div class="column-count-2">
                                                                @foreach ($featureVilla as $value)
                                                                    {{ Form::checkbox('featured[]', $value->id, in_array($value->id, $featureActive) ? true : false, ['class' => 'allFeature']) }}
