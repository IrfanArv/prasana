                ...
                <div class="col-md-12 col-12">
                    <div class="card">
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <form action="{{ route('gallery.update', ['id' => $gallerys->id]) }}" method="POST" enctype="multipart/form-data">
                                    @method('PUT')
                                    @csrf
                                    <div class="form-body">
                                        <div class="row">
                                            <div class="col-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input name="title" value="{{ old('title', $gallerys->title) }}" type="text" class="form-control">
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-12">
