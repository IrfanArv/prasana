                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper col-12">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">Edit Offers
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content">
                                        ...
                                        <div class="row">
                                                    ...
                                                    <div class="col-auto">
                                                        @if ($data->image)
                                                            <img class="img-fluid rounded" id="modal-preview"
                                                                src="{{ asset('/img/products/' . $data->image) }}"><br><br>
                                                        @else
                                                            <img class="img-fluid rounded" id="modal-preview"
                                            ...
                                            <div class="col-md-12 px-3 pt-2">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input value="{{ old('title', $data->title) }}" name="title"
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="ckeditor" name="description" id="description" cols="30" rows="10">{{ old('description', $data->description) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-4">
						 ...
						 <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <select class="form-control" name="send_to" id="send_to">
                                                            ...
                                                            @if (old('send_to', $data->send_to) === 'booking_engine')
                                                                <option value="wa">WhatsApp</option>
                                                                <option value="email">Email</option>
                                                                <option value="booking_engine" selected>Booking Engine
                                                                </option>
                                                                <option value="external_link">External Link</option>
                                                            @endif
                                                            @if (old('send_to', $data->send_to) === 'external_link')
                                                                <option value="wa">WhatsApp</option>
                                                                <option value="email">Email</option>
                                                                <option value="booking_engine">Booking Engine
                                                                </option>
                                                                <option value="external_link" selected>External Link
                                                                </option>
                                                            @endif
                                                        </select>
                                                    </div>
                                                ...
                                                {{-- external link --}}
                                                <div class="form-group row" id="external_link_group"
                                                    style="display: none;">
                                                    <div class="col-md-4">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input name="external_link" id="external_link" type="text"
                                                            class="form-control" value="{{ old('link', $data->link) }}">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <textarea class="form-control" name="meta_desc" id="meta_desc" cols="10" rows="2">{{ old('meta_desc', $data->meta_desc) }}</textarea>
                                                    </div>
                                                </div>
                                                <div class="form-group row">
                                                    <div class="col-md-4">
 ...
 document.addEventListener('DOMContentLoaded', function() {
            ...
            function toggleExternalLinkInput() {
                if (sendToSelect.value === 'external_link') {
                    externalLinkGroup.style.display = 'flex'; // Show the input
                } else {
                    externalLinkGroup.style.display = 'none'; // Hide the input
                    externalLinkInput.value = ''; // Clear the input value if hidden
                }
            }
