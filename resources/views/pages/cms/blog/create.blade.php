        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-left mb-0">New Post</h2>
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="card">
                            <div class="card-body p-0">
                                <textarea class="form-control" name="content" id="content" cols="30" rows="15"
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <textarea class="form-control" name="excerpt" id="excerpt" rows="3"
                                    placeholder="Short summary for preview cards (will be auto-generated from content if left empty)..."></textarea>
                            </div>
                        </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button type="submit" class="btn btn-primary btn-sm">
                                        <i class="feather icon-send mr-25"></i>Save Post</button>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="card sidebar-card mb-2">
                            ...
                            <div class="card-body">
                                <div class="seo-preview mb-1">
                                    <div class="seo-title" id="seo-preview-title">Post Title — Prasana</div>
                                    <div class="seo-url" id="seo-preview-url">prasanaresort.com › blog › ...</div>
                                    <div class="seo-desc" id="seo-preview-desc">Post description will appear here...</div>
                                </div>
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control form-control-sm" name="meta_desc" id="meta_desc"
                                        rows="2" placeholder="Auto-filled from excerpt"></textarea>
                                </div>
                                <div>
                                    <label class="small text-muted mb-25">Meta Keywords</label>
                                    <input name="meta_keyword" id="meta_keyword" type="text"
                                        class="form-control form-control-sm" placeholder="comma, separated, keywords">
                                </div>
                            </div>
                        </div>
                    </div>
